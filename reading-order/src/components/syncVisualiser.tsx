...
function SyncVisualiser() {
    ...
    return ( 
        <span className={`${syncStatus.message==="" ? "opacity-0" : "opacity-90"} transform transition duration-300 absolute inline-flex justify-center items-center bottom-1/4 mx-auto right-0 left-0 max-w-40 min-w-24 z-30`}>
