...
exports.isAuthenticatedTwitter = passport.authenticate("twitter", {scope: ["email","profile"]});
exports.isAuthenticatedTwitterCallback = passport.authenticate("twitter", {session:false});